...
```shell
node ./index.js --run --sourceFolder "../peterknijff.github.io/static/images" --targetFolder "../matfantinel.github.io/static/optimized-images" --inputFormats "jpg" --inputFormats "jpeg" --inputFormats "png" --outputFormats "webp" --outputFormats "avif" --outputFormats "png"
```
