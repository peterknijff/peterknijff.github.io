...
<article class="resume">
	...
	<section class="about">
		...
		<p>
			Mijn passie is het bouwen van snelle, intuitieve en goed uitziende websites en applicaties. Ik
			blijf graag bij met de nieuwste technieken en probeer deze dan ook graag uit.
		</p>
	</section>
	<section class="work">
		<SectionTitle>Werk ervaring</SectionTitle>
	...
	<section class="education">
		...
		<p>
			...
			<b>Mediatechnologie (CMGT)</b> aan de{' '}
			<i>Hogeschool Rotterdam</i>, 2016.
		</p>
	</section>
