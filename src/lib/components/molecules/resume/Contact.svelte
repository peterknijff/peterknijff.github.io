...
<ul class="resume-contact">
	<li class="birthday">
		...
		<span>{calculateYearsSince(new Date('02-03-1990'))} years old</span>
	</li>
	<li class="experience">
	...
	<li class="location">
		...
		<span>Zevenbergen, Holland</span>
	</li>
	<li class="email">
		<span class="icon"><EmailIcon /></span>
		<a href="mailto:info@peterknijff.nl">info@peterknijff.nl</a>
	</li>
	<li class="linkedin">
		<span class="icon"><LinkedInIcon /></span>
		<a
			href="https://www.linkedin.com/in/peterknijff/"
			target="_blank"
	...
	<li class="website">
		...
		<a href="https://peterknijff.nl" target="_blank" rel="noopener noreferrer"> peterknijff.nl </a>
	</li>
	<li class="github">
		<span class="icon"><GitHubIcon /></span>
		<a href="https://github.com/peterknijff" target="_blank" rel="noopener noreferrer">
			GitHub Profile
		</a>
	</li>
	<li class="languages">
